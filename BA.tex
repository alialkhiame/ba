...
\textbf{User Experience} (UX) ist ein Teilbereich der HCI, der in den frühen 1990er Jahren an Bedeutung gewann \cite{glanznig}. 
...
\subsubsection{Konsequenzen einer eingeschränkten Beobachtung der User Experience in eDok} \label{subsubsec:konsequenzen_eingeschraenkte_ux}
